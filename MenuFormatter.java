...
public class MenuFormatter {
    ...
    public JPanel addThemeButtonPanel() {
        ...
        themeButtonPanel.setLayout(new GridLayout(1, 3, 20, 15));

        this.setButton(selectionMenu.getThemeOneButton(), Color.WHITE, Color.BLACK, 0, e -> {
        	selectionMenu.setStyleFormatter(new SimpleFormatter(selectionMenu.getDisplayboard()));
        	}
        );
        this.setButton(selectionMenu.getThemeTwoButton(), Color.WHITE, Color.BLACK, 0, e -> {
        	selectionMenu.setStyleFormatter(new RealisticFormatter(selectionMenu.getDisplayboard()));
        	}
        );
